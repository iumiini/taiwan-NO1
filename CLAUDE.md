...
| 規格現況（給人看） | Inbox 編號頁 `01`～`05`、[D2｜資料管線](https://app.notion.com/p/3e4fd52e6764816f8cddd99908ede2c8) |
...
專案頁的摺疊區塊**已凍結**。Inbox 頁用「編號｜」前綴（全形直線）；各頁清單以
...
| 層 | 檔案 | 性質 |
|---|---|---|
| 規格現況（給人看） | Notion 權威頁 `00`～`05`、`D2` | 規則、意圖、狀態；不刪只劃線 |
